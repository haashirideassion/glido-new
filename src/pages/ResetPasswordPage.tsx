      ...
      <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 400 }}>
        <div style={{ background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.08)', borderRadius: 24, padding: '44px 40px', boxShadow: '0 2px 8px rgba(0,0,0,0.04),0 16px 48px rgba(0,0,0,0.09)' }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 13, color: '#78716C', lineHeight: 1.6 }}>This link was sent to your email. Choose a new password below.</p>
          </div>
          <div style={{ background: 'rgba(252,101,20,0.08)', border: '1px solid rgba(252,101,20,0.22)', borderRadius: 10, padding: '14px 16px', fontSize: 13, color: '#FC6514', textAlign: 'center', lineHeight: 1.5 }}>
