  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '120px 32px 40px', overflowY: 'auto' }}>
      <div style={{ width: '100%', maxWidth: 448, textAlign: 'center' }}>
        <div style={{ width: 64, height: 64, background: 'rgba(245,158,11,0.10)', borderRadius: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
        ...
        <p style={{ color: '#78716C', marginBottom: 32 }}>We need to verify your identity before check-in</p>
        ...
        <div style={{ textAlign: 'left', background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.07)', borderRadius: 16, padding: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.04),0 4px 20px rgba(0,0,0,0.07)', marginBottom: 24 }}>
          <p style={{ fontWeight: 600, marginBottom: 12, fontSize: 14, color: '#1C1917' }}>What we collect &amp; why:</p>
          <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 16px', display: 'flex', flexDirection: 'column', gap: 8 }}>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <span style={{ color: '#C7C1BB', marginTop: 2 }}>•</span>
              <span style={{ fontSize: 14, color: '#78716C' }}><strong style={{ color: '#1C1917' }}>Name, licence number, expiry</strong> — to verify your identity matches the booking</span>
            </li>
            <li style={{ display: 'flex', alignItems: 'flex-start', gap: 8 }}>
              <span style={{ color: '#C7C1BB', marginTop: 2 }}>•</span>
              <span style={{ fontSize: 14, color: '#78716C' }}><strong style={{ color: '#1C1917' }}>Date of birth &amp; address</strong> — stored for compliance and security auditing</span>
            </li>
          </ul>
        ...
        <button className="kiosk-btn kiosk-btn-primary" style={{ width: '100%', borderRadius: 16, marginBottom: 12 }} onClick={acceptConsent}>
          <Icon name={ICONS.shield} size={22} />
          I agree — Scan My ID
        </button>
        <button className="kiosk-btn kiosk-btn-secondary" style={{ width: '100%', borderRadius: 16, fontSize: 14 }} onClick={completeCheckIn}>
