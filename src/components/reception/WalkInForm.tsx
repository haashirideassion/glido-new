...
export const WalkInForm = () => (
  <div class="max-w-2xl">
    ...
    <div
      ...
      style="background:rgba(252,101,20,0.06); border:1px solid rgba(252,101,20,0.18); border-radius:12px; padding:18px 20px;"
    >
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#FC6514" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0 mt-0.5">
        <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
      </svg>
      <div>
        <p style="font-size:16px; font-weight:700; color:#FC6514; margin-bottom:4px;">Visitor Registration</p>
